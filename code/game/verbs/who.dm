...
/client/verb/staffwho()
	...
	msg = "<b>Current Executive & Administration Team Members ([num_admins_online]):</b>\n" + msg

	if(config.show_mods)
		msg += "\n<b> Current Moderation Team Members ([num_mods_online]):</b>\n" + modmsg

	if(config.show_mentors)
		msg += "\n<b> Current Development & Support Team Members ([num_mentors_online]):</b>\n" + mentmsg
